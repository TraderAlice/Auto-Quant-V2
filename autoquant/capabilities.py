...
CLI_COMMANDS = [
    ...
    descriptor(
        "job.execute",
        "aq job execute <path> --study ID [--executor cpu|gpu|moss] [resource options] [--project ID] [--json]",
        "Execute one Study through the provider-neutral ComputeJob contract and publish an immutable terminal receipt; the public build includes only the CPU executor.",
        "creates-artifact",
        [PATH_ARGUMENT, PROJECT_ARGUMENT, STUDY_ARGUMENT, JSON_ARGUMENT],
    ),
    descriptor(
        "job.list",
        "aq job list <path> [--project ID] [--json]",
        "Verify and list immutable ComputeJob receipts.",
        "read-only",
        [PATH_ARGUMENT, PROJECT_ARGUMENT, JSON_ARGUMENT],
    ),
    descriptor(
        "job.show",
        "aq job show <path> --job ID [--project ID] [--json]",
        "Verify and inspect one immutable ComputeJob receipt.",
        "read-only",
        [PATH_ARGUMENT, PROJECT_ARGUMENT, JSON_ARGUMENT],
    ),
    descriptor(
        "job.providers",
        "aq job providers [--json]",
        "Declare built-in and private-plugin compute executors without exposing credentials or plugin protocols.",
        "read-only",
        [JSON_ARGUMENT],
    ),
    descriptor(
        "model.run",
        "aq model run <path> --study ID --frame PATH --label COLUMN --feature COLUMN --split-column COLUMN [options] [--project ID] [--json]",
        "Execute a point-in-time supervised model Study and publish an immutable model Run with validation-only selection, test-only terminal audit, and no trading authority.",
        "creates-artifact",
        [PATH_ARGUMENT, PROJECT_ARGUMENT, STUDY_ARGUMENT, JSON_ARGUMENT],
    ),
    descriptor(
        "model.list",
        "aq model list <path> [--project ID] [--json]",
        "Verify and list immutable supervised-model Runs.",
        "read-only",
        [PATH_ARGUMENT, PROJECT_ARGUMENT, JSON_ARGUMENT],
    ),
    descriptor(
        "model.show",
        "aq model show <path> --model-run ID [--project ID] [--json]",
        "Verify and inspect one immutable supervised-model Run.",
        "read-only",
        [PATH_ARGUMENT, PROJECT_ARGUMENT, JSON_ARGUMENT],
    ),
    descriptor(
        "event.intake",
        "aq event intake <path> --package FILE [--project ID] [--json]",
        "Validate and materialize a point-in-time A-share announcement, crypto-event, or financial-news package with source, license, visibility clocks, and content hashes.",
        "creates-artifact",
        [PATH_ARGUMENT, PROJECT_ARGUMENT, JSON_ARGUMENT],
    ),
    descriptor(
        "event.list",
        "aq event list <path> [--project ID] [--json]",
        "Verify and list materialized event snapshots.",
        "read-only",
        [PATH_ARGUMENT, PROJECT_ARGUMENT, JSON_ARGUMENT],
    ),
    descriptor(
        "event.show",
        "aq event show <path> --event-package ID --version VERSION [--project ID] [--json]",
        "Verify and inspect one materialized point-in-time event snapshot.",
        "read-only",
        [PATH_ARGUMENT, PROJECT_ARGUMENT, JSON_ARGUMENT],
    ),
    descriptor(
        "verify.assess",
        "aq verify assess <path> --claim FILE --evidence FILE [--project ID] [--json]",
        "Publish an immutable four-state VerificationAssessment from strict external claim and evidence contracts.",
        "creates-artifact",
        [PATH_ARGUMENT, PROJECT_ARGUMENT, JSON_ARGUMENT],
    ),
    descriptor(
        "verify.factor",
        "aq verify factor <path> --run ID --statement TEXT [threshold options] [--project ID] [--json]",
        "Assess one verified Factor Run against an explicit external claim without inferring author intent.",
        "creates-artifact",
        [PATH_ARGUMENT, PROJECT_ARGUMENT, RUN_ARGUMENT, JSON_ARGUMENT],
    ),
    descriptor(
        "verify.list",
        "aq verify list <path> [--project ID] [--json]",
        "Verify and list immutable VerificationAssessments.",
        "read-only",
        [PATH_ARGUMENT, PROJECT_ARGUMENT, JSON_ARGUMENT],
    ),
    descriptor(
        "verify.show",
        "aq verify show <path> --assessment ID [--project ID] [--json]",
        "Verify and inspect one immutable VerificationAssessment.",
        "read-only",
        [PATH_ARGUMENT, PROJECT_ARGUMENT, JSON_ARGUMENT],
    ),
    descriptor(
