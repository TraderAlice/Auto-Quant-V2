...
CLI_COMMANDS = [
    ...
    descriptor(
        ...
        [
            ...
            argument(
                ...
                "integer",
                False,
                "Maximum evaluated candidates; defaults to the legacy turn ceiling and cannot exceed it.",
            ),
            argument(
                "max-wall-seconds",
                "option",
            ...
            argument(
                ...
                "integer",
                False,
                "Conservative public CPU ceiling; defaults to the wall-clock ceiling.",
            ),
            argument(
                "max-gpu-seconds",
                "option",
                "integer",
                False,
                "Declared GPU ceiling. Public execution remains CPU-first and does not install or invoke a private provider.",
                default=0,
            ),
            argument(
    ...
    descriptor(
        ...
        "Validate one closed provider-neutral Operator request and publish or replay its immutable terminal receipt; no arbitrary shell or provider command is accepted.",
        "creates-artifact",
        [
            PATH_ARGUMENT,
            PROJECT_ARGUMENT,
            argument(
                ...
                "string",
                True,
                "Strict Operator request JSON file. The request carries exact object references, authority, budget, confirmation, and expected state; it cannot carry commands or credentials.",
            ),
            JSON_ARGUMENT,
        ],
    ),
