...
contract. The preserved Factor Run
...
contract was bound into all three Study lanes. The preserved Factor Run
...
The earlier close-time Factor Run
...
recording the generalized same-or-prior-timestamp causal context contract. The
current Factor Run `run-20260801T190954461897Z-2e8462aa4547` was produced by
...
as a released version. The current Factor Run
`run-20260801T212920787441Z-4fafdd0a9412` was produced by the clean `0.9.26`
candidate source Harness at commit `3cd8cd9` after observed Factor packages
...
current Portfolio Run
`run-20260731T172357866325Z-4f640b413ddf` was produced by the clean `0.9.4`
